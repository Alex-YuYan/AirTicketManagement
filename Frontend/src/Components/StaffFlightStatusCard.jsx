...
const StaffFlightStatusCard = ({ flight }) => {
  return (
    <div className="border border-gray-300 p-4 rounded-md shadow-md space-y-2 mt-4">
      <h2 className="text-xl font-semibold">{flight.airline_name} {flight.flight_number} - {flight.airplane_id}</h2>
      ...
      <div className="mt-4 flex justify-center items-center">
        <p className="text-md mr-8"> Base Price: ${flight.base_price} </p>
